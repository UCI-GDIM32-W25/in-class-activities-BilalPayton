...
{
	public override void Talk(string playerName) { Debug.Log("Hi! I'm an NPC.");  }
...
{
	public override void Talk(string PlayerName) { Debug.Log("I'm an enemy mwahahahahahahah!");  }
}